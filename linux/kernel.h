...
extern int oops_in_progress; /* If set, an oops, panic(), BUG() or die() is in
                                progress */
 ...
 */
static inline void set_arch_panic_timeout(int timeout,
...
#define max_t(type, x, y) \
    __max(type, type, __UNIQUE_ID(min1_), __UNIQUE_ID(min2_), x, y)
